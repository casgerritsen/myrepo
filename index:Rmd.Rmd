...
# Chroma-based and timbre-based SSM

Below are two cepstograms; one of Kygo's 'Higher Love' and one of Avicii's 'Hey Brother'. These songs are chosen, because of the popularity, as the two are relatively in the middle in terms of streams. Also, the researcher's personal interest is another reason. <br>
