...
# Plotting
ggplot(combined_data, aes(x = artist, y = speechiness, fill = artist)) +
  geom_boxplot(position = position_dodge(width = 0.8)) +
  labs(title = "Comparison of speechiness between Kygo and Avicii",
       x = "Artist",
       y = "Speechiness") +
  theme_minimal()
```
...
Note: Especially with Kygo's plot, there are just too many songs to keep it organized. Maybe I'll change it by album, but then some songs won't be included, so I have my doubts.
